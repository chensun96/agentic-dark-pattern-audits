...
DP_PROMPT_USER_PATH = "prompts/baseline_zero_shot/prompt.txt"
#DP_TAXONOMY_JSON   = "prompts/baseline_zero_shot/sneaking.json"
# --------------------------
...
if __name__ == "__main__":
    DP_TAXONOMY_JSONS = [
        "prompts/baseline_zero_shot/sneaking.json",
        "prompts/baseline_zero_shot/interface_interference.json",
        "prompts/baseline_zero_shot/obstruction.json",
    ]
    taxonomy_to_type = {
        "prompts/baseline_zero_shot/sneaking.json":
            "sneaking_baseline_zero_shot",

        "prompts/baseline_zero_shot/interface_interference.json":
            "interface_interference_baseline_zero_shot",

        "prompts/baseline_zero_shot/obstruction.json":
            "obstruction_baseline_zero_shot",
    }
