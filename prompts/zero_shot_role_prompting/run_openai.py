...
DP_PROMPT_USER_PATH = "prompts/zero_shot_role_prompting/prompt_regulator_role.txt"
#DP_TAXONOMY_JSON   = "prompts/zero_shot_role_prompting/sneaking.json"
# --------------------------
...
if __name__ == "__main__":
    ...
    DP_TAXONOMY_JSONS = [
        "prompts/zero_shot_role_prompting/sneaking.json",
        "prompts/zero_shot_role_prompting/interface_interference.json",
        "prompts/zero_shot_role_prompting/obstruction.json",
    ]
    taxonomy_to_type = {
        "prompts/zero_shot_role_prompting/sneaking.json":
            "sneaking_zero_shot_regulator_role",

        "prompts/zero_shot_role_prompting/interface_interference.json":
            "interface_interference_zero_shot_regulator_role",

        "prompts/zero_shot_role_prompting/obstruction.json":
            "obstruction_zero_shot_regulator_role",
    }
